# Jacob's .cshrc file. Shamelessly copied, then modified from Sean's excellent version
# available at https://github.com/sean-/dotfiles/blob/master/tcsh/.cshrc
#
# I keep it in ~/git/dotfiles/dot.chsrc and simply include in my ~/.tcshrc as first line
# source ~/git/dotfiles/dot.cshrc
#
